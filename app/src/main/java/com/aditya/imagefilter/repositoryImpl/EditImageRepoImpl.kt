...
import com.aditya.imagefilter.repository.EditImageRepo
...
class EditImageRepoImpl @Inject constructor(@ApplicationContext val context: Context) :
    EditImageRepo {
    ...
    override suspend fun saveFilteredImage(filterImage: Bitmap): Uri? {
